  ...
  return (
    <div className='text-justify'>
            ...
            <div className='sm:mt-6'>
                ...
                <p className='sm:w-[395px] sm:text-[12px] sm:leading-[18px] sm:font-normal sm:mt-2'>Refund of amount  <span className='sm:font-semibold text-[#304BA0]'>AED 200.00</span> has been processed and credited back to your original payment method.</p>
            </div>
            <div className=' w-fit'>
