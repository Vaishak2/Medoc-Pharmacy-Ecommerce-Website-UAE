...
function PDPreviewedDetails({ title, review }) {
    ...
    const customerPhotos = [
        Review,
         // Use the `Review` image source directly
         Review,
         Review,
         Review,
         Review,
    ...
    const reviews = [
      {
        ...
        rating: 4.5,
        date: "18/05/2024",
        review: review, // Update this to use the dynamic review prop
        helpful: '(16)',
        notHelpful: '(6)',
        tittle: title, // Update this to use the dynamic title prop
        verified: true,
      },
      {
        id: 2,
   ...
   <div className="flex text-justify">
                 ...
                 <div className=''>
                     ...
                     <div>                        <h1 className="sm:text-[18px] sm:leading-6 sm:mt-6 text-justify">
                 ...
                 <div className="flex-1 ml-6">
                   ...
                   <CustomerPhotos photos={customerPhotos} />
                     ...
                     <div className="mt-4 flex gap-2 ">
                         ...
                         >Most recent</button>                    <button className={`px-4 py-2 border border-[#304ba0] text-[#304ba0] rounded-lg ${activeFilter=== 'positive' ? 'bg-[#304ba0] text-white':''} `}
        ...
        {reviews.map((review) => (
          <div key={review.id} className="">
            <div className='border-t border-r border-l rounded-b-none rounded-lg px-6 pt-6 pb-4'>
              ...
              <div className='text-justify text-sm sm:font-semibold sm:mt-6'>{review.tittle}</div> {/* Display the title */}
              <div className="mt-4 text-justify sm:text-sm sm:font-normal">{review.review}</div> {/* Display the review */}
            </div>
