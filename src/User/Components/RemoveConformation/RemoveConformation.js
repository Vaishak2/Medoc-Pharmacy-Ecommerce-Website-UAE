...
function RemoveConformation({ onRemove, onCancel }) {
  return (
    <div>
      <div className='sm:w-[428px] sm:h-[320px] rounded-xl border p-10 text-justify bg-white'>
        ...
        <div className='sm:mt-6'>
          <h1 className='sm:text-[16px] sm:font-semibold sm:leading-6'>Remove this item?</h1>
          <h2 className='sm:mt-2 text-[#818180] sm:text-[14px] sm:leading-6'>Are you sure you want to remove this? This action cannot be undone.</h2>
        </div>
